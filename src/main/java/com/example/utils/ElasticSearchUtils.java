...
public class ElasticSearchUtils {
    ...
    private void init() {
        try {
            ...
            if (StringUtils.isBlank(uris)) {
                System.out.println("spring.elasticsearch.rest.uris is blank");
                return;
            }
    ...
    public String addData(Object object, String index, String id) throws IOException {
        ...
        System.out.println("添加数据成功 索引为: {}, response 状态: {}, id为: {}"+ index+ response.status().getStatus()+ response.getId());
    ...
    public String updateDataById(Object object, String index, String id) throws IOException {
        ...
        System.out.println("索引为: {}, id为: {},updateResponseID：{}, 更新数据成功"+ index+ id+ updateResponse.getId());
    ...
    public String updateDataByIdNoRealTime(Object object, String index, String id) throws IOException {
        ...
        //执行更新请求
        UpdateResponse updateResponse = restHighLevelClient.update(updateRequest, RequestOptions.DEFAULT);
        System.out.println("索引为: {}, id为: {},updateResponseID：{}, 实时更新数据成功"+ index+ id+ updateResponse.getId());
        return updateResponse.getId();
    }
